...
const ProductCardLoader = () => {
  return (
    <div className="w-full justify-center items-center min-h-60 rounded-md py-4 px-4 sm:py-6 sm:px-8 md:px-12 mx-4 flex flex-col gap-6 sm:gap-10 hover:shadow-md duration-200">
      {[1,2,3].map((item) => (
        <div key={ item } className="w-full max-w-4xl sm:max-w-2xl md:max-w-3xl lg:max-w-4xl xl:max-w-5xl min-h-44 bg-white rounded-md py-4 px-4 sm:py-6 sm:px-8 md:px-12 border-1 flex flex-col gap-2 hover:shadow-md duration-200 cursor-pointer hover:bg-gray-50">
